...
import { SelectMessage } from 'src/redux/araNakliye/sevkiyatAktarimlariSlice'
      ...
      value: (item) => (
        <div>
          ...
          <button
            onClick={() => {
              setModalOpen(false)
              navigate('/araNakliyeci/sevkiyat-islemleri/1')
            }}
          >
      ...
      value: (item) => (
        <div>
          ...
          <button
            onClick={() => {
              setModalOpen(false)
              navigate('/araNakliyeci/sevkiyat-islemleri/2')
            }}
          >
            <span className="text-xl">{item.linkTitle}</span>
          </button>
