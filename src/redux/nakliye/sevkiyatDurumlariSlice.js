...
export const getSevkiyatlar = createAsyncThunk(
  ...
  async (params, { rejectWithValue }) => {
    try {
      ...
      const response = await axios.post(`${config.url}/nakliyeci/get_sevkiyatlar`, {
...
export const sevkiyat_sayilarini_cek = createAsyncThunk(
  ...
  async (params, { rejectWithValue }) => {
    try {
      let user = Cookies.get('auth') ? JSON.parse(Cookies.get('auth')).user : null
      const { data } = await axios.post(`${config.url}/nakliyeci/sevkiyat_sayilari`, {
        user_id: user.id,
      })
      return data
    } catch (error) {
...
// Selectors
export const sevkiyatlar = (state) => state.nakliye_sevkiyat.data
export const SevkiyatSayilari = (state) => state.nakliye_sevkiyat.sevkiyatSayilari
export const loading = (state) => state.nakliye_sevkiyat.loading
export const error = (state) => state.nakliye_sevkiyat.error
